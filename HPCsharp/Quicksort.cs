...
namespace HPCsharp
{
    static public partial class Algorithm
    {
        ...
        public static void Quicksort2(this uint[] src, Int32 b, Int32 e)
        {
            if (b >= e) return;
        ...
        public static void Quicksort3(this uint[] src, Int32 b, Int32 e)
        {
            if ((e - b) < 2)
                return;
        ...
        public static void Quicksort4<T>(this T[] src, Int32 b, Int32 e, IComparer<T> comparer = null)
        {
            if ((e - b) < 2)
                return;
            ...
            Quicksort4(src, b, j, comparer);
            Quicksort4(src, j, e, comparer);
        }
    }
}
